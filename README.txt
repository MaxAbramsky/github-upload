Author: Max Abramsky
NetID: maa180013
Project: Linked List and generics
Files: IDedObject.java, MyItem.java, IDedLinkedList.java, P2Driver.java
IDE: JGrasp
Java: JDK 15
Other notes: I used a default java linked list for the itemDescription list type as that is what was used in the driver method. This has nothing to do with my own original linked list class.
